...
// Generated at 2015/12/01 22:45:05 (+0800)
...
func GetAuthorizeDataStore(r *http.Request) (s *AuthorizeDataStore, err error) {
	...
	// obtain session ID (note: need documentation)
	logPrefix := ""

	if sessID := gourdctx.GetRequestID(r); sessID != "" {
		logPrefix = "[" + sessID + "] "
	}

	// define store and return
	s = &AuthorizeDataStore{db, logPrefix}
	s.Log("GetAuthorizeDataStore")
	return
}
